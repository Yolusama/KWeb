...
namespace Koober
{
    public abstract partial class KooberBase<T,ID> : IDisposable
    {
        ...
        public abstract List<TR> Query<TR>(PagedQuery<TR> page, string command, params object[] values);
        public abstract List<TR> Query<TR>(PagedQuery<TR> page, string command,Func<T,TR> result, params object[] values);
        ...
        public abstract List<TR> Query<Q,TR>(PagedQuery<TR> page, string command, Q query);
        public abstract List<TR> Query<Q,TR>(PagedQuery<TR> page, string command,Func<T,TR> result, Q query);
